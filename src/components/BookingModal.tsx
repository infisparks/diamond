...
export function BookingModal({
  ...
  const handleStep1Submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fbEvent("Lead", {
        content_name: activeCampaign.title || "Diamond Boutique Consultation Form",
  ...
  const handleStep2Submit = async () => {
    ...
    fbEvent("CompleteRegistration", {
      content_name: "Diamond Boutique Consultation Survey",
      campaign: activeCampaign.id,
    });
  ...
  const handleSelectSlot = async (timeSlot: string) => {
    ...
    fbEvent("Schedule", {
      content_name: `Store Visit Consultation - ${appointmentDateStr} ${timeSlot}`,
      campaign: activeCampaign.id,
    });
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-2.5 sm:p-4 overflow-y-auto">
      ...
      {showAlreadySubmittedPopup ? (
        <div className="bg-gradient-to-b from-[#24084c] via-[#1a0538] to-[#100324] text-white border border-purple-400/40 w-full max-w-md sm:max-w-lg rounded-3xl p-5 sm:p-7 shadow-2xl relative max-h-[92vh] overflow-y-auto font-sans text-center my-auto">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 w-8 h-8 rounded-full text-slate-400 hover:text-white hover:bg-purple-900 flex items-center justify-center text-sm transition-colors cursor-pointer"
          >
            <i className="fa-solid fa-xmark"></i>
          </button>

          <div className="w-16 h-16 rounded-full bg-amber-500/20 border-2 border-amber-500 text-amber-400 flex items-center justify-center text-3xl mx-auto shadow-lg mb-3">
            <i className="fa-solid fa-circle-check"></i>
          </div>

          <div className="inline-flex items-center space-x-1.5 bg-amber-500/10 border border-amber-500/30 px-3 py-1 rounded-full text-amber-300 text-xs font-bold mb-3">
          ...
          <p className="text-xs sm:text-sm text-slate-300 font-medium leading-relaxed mt-2 max-w-sm mx-auto">
            We already have your contact details on file for Diamond Boutique. For urgent assistance or wholesale queries, chat with us directly:
          </p>

          {contactInfo.fullName && (
            <div className="bg-[#12032b] border border-purple-500/30 rounded-2xl p-3.5 mt-4 text-left text-xs space-y-1.5 font-mono shadow-inner">
          ...
          <div className="space-y-2.5 mt-5">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <button
                ...
                className="bg-purple-900/60 hover:bg-purple-900 border border-purple-400/40 text-purple-200 font-bold py-2.5 px-3 rounded-xl text-xs transition-colors flex items-center justify-center space-x-1.5 cursor-pointer"
              >
        ...
        <>
          {/* Step 1: Contact Form */}
          {step === 1 && (
            <div className="bg-gradient-to-b from-[#24084c] via-[#1a0538] to-[#100324] text-white border border-purple-500/40 w-full max-w-md sm:max-w-lg rounded-3xl p-4 sm:p-7 shadow-2xl relative max-h-[92vh] overflow-y-auto font-sans my-auto">
              <div className="flex items-center justify-between border-b border-purple-500/30 pb-3 mb-3">
                <div className="flex items-center space-x-2">
                  <span className="bg-purple-600/30 border border-purple-400/40 text-amber-300 text-[10px] font-black px-2.5 py-0.5 rounded-full">
                    Step 1 of 3
                  </span>
                ...
                <button
                  onClick={handleReset}
                  className="w-7 h-7 rounded-full text-slate-400 hover:text-white hover:bg-purple-900 flex items-center justify-center text-sm transition-colors cursor-pointer"
                >
                  <i className="fa-solid fa-xmark"></i>
                </button>
              </div>
              ...
              <form onSubmit={handleStep1Submit} className="space-y-3.5 text-left">
                <div className="text-center space-y-1">
                  <h3 className="text-base sm:text-xl font-black text-white leading-snug font-serif">
                    Diamond Boutique Consultation &amp; Visit Request
                  </h3>
                  <p className="text-[11px] sm:text-xs text-purple-200 font-medium">
                    Enter your details to connect with our master stylists &amp; wholesale team in Attar Gali
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    autoComplete="name"
                    placeholder="e.g. Ayesha Khan / Boutique Name"
                    ...
                    className="w-full bg-[#12032b] border border-purple-500/30 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 rounded-xl px-3.5 py-2.5 sm:py-3 text-sm text-white placeholder-slate-400 shadow-inner outline-none transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-[#12032b] border ${
                ...
                <div>
                  ...
                  <div className={`flex items-center bg-[#12032b] border ${
                    ...
                    <select
                      ...
                      className="bg-[#1a0538] text-white text-xs sm:text-sm font-bold border-r border-purple-500/30 px-2.5 py-2.5 sm:py-3 outline-none cursor-pointer"
                    >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-slate-950 py-3.5 sm:py-4 rounded-2xl font-extrabold text-sm sm:text-base flex flex-col items-center justify-center space-y-0.5 shadow-[0_8px_25px_rgba(245,158,11,0.4)] active:scale-98 overflow-hidden transition-all cursor-pointer mt-4 disabled:opacity-50"
                >
                  ...
                  <div className="text-[10px] sm:text-xs font-extrabold text-purple-950">
          ...
          {step === 2 && (
            <div className="bg-gradient-to-b from-[#24084c] via-[#1a0538] to-[#100324] text-white border border-purple-500/40 w-full max-w-xl rounded-2xl sm:rounded-3xl p-4 sm:p-7 shadow-2xl relative max-h-[92vh] overflow-y-auto font-sans flex flex-col justify-between my-auto">
              <div>
                <div className="flex items-center justify-between border-b border-purple-500/30 pb-2.5 mb-3">
                  <div className="flex items-center space-x-2">
                    <span className="bg-purple-600/30 border border-purple-400/40 text-amber-300 text-[10px] font-black px-2.5 py-0.5 rounded-full">
                  ...
                  <button
                    onClick={handleReset}
                    className="w-7 h-7 rounded-full text-slate-400 hover:text-white hover:bg-purple-900 flex items-center justify-center text-sm cursor-pointer"
                  >
                    <i className="fa-solid fa-xmark"></i>
                  </button>
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-3 pt-1">
                      <div className="text-sm sm:text-base md:text-lg font-bold text-slate-100 flex items-start space-x-2">
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left p-2.5 sm:p-3 rounded-xl border flex items-center justify-between transition-all duration-200 cursor-pointer ${
                                isSelected
                                  ? "bg-purple-900/80 border-2 border-amber-400 text-white shadow-[0_0_15px_rgba(245,158,11,0.3)]"
                                  : "bg-[#140428] border-purple-500/30 text-slate-200 hover:border-purple-400 hover:bg-[#1f073d]"
                              }`}
                            >
                              <span className="text-xs sm:text-sm font-semibold">{opt.label}</span>
                              <span className="w-5 h-5 rounded-full border border-purple-400/40 text-purple-300 text-[10px] font-mono flex items-center justify-center bg-[#0c021c] flex-shrink-0 ml-2">
                                {opt.key}
                              </span>
                            </button>
                          );
              ...
              <div className="pt-4 border-t border-purple-500/30 flex items-center justify-between mt-5">
                <div className="flex items-center space-x-3">
                  {activeQIndex === qualificationQuestions.length - 1 ? (
                    <button
                      type="button"
                      onClick={handleStep2Submit}
                      className="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 font-extrabold px-4 py-2 sm:px-5 sm:py-2.5 rounded-full text-xs sm:text-sm uppercase tracking-wide flex items-center space-x-2 shadow-lg cursor-pointer hover:brightness-110"
                    >
                      <span>Submit</span>
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 font-bold px-4 py-1.5 sm:py-2 rounded-full text-xs flex items-center space-x-1.5 shadow cursor-pointer hover:brightness-110"
                    >
                      <span>OK</span>
                      <i className="fa-solid fa-chevron-right text-xs"></i>
                    </button>
                ...
                <div className="flex items-center space-x-1.5">
                  <button
                    ...
                    className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-purple-900 border border-purple-400/40 text-amber-300 hover:bg-purple-800 flex items-center justify-center disabled:opacity-30 disabled:pointer-events-none transition-colors cursor-pointer"
                  >
          ...
          {step === 3 && (
            <div className="bg-gradient-to-b from-[#24084c] via-[#1a0538] to-[#100324] text-white border border-purple-500/40 w-full max-w-lg rounded-2xl sm:rounded-3xl p-3.5 sm:p-6 shadow-2xl relative max-h-[92vh] overflow-y-auto font-sans space-y-3 my-auto">
              <div className="flex items-center justify-between border-b border-purple-500/30 pb-2.5">
                <p className="text-xs sm:text-sm font-bold text-purple-200">
                  Select date &amp; time for your Store Visit / Fitting Call
                </p>
                <button
                  onClick={handleReset}
                  className="w-7 h-7 rounded-full text-slate-400 hover:text-white hover:bg-purple-900 flex items-center justify-center text-sm cursor-pointer"
              ...
              <div className="bg-[#140428] border border-purple-500/30 rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 space-y-3.5 shadow-xl">
                <div className="flex items-center justify-between border-b border-purple-500/20 pb-2.5">
                  <div className="flex items-center space-x-2.5">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-600 to-amber-400 flex items-center justify-center text-white font-bold shadow">
                  ...
                  <div className="flex items-center space-x-1 bg-amber-500/10 border border-amber-500/30 px-2.5 py-1 rounded-full text-[10px] sm:text-xs text-amber-300 font-mono font-bold">
                ...
                <div className="flex items-center justify-between text-[11px] text-purple-200 px-1">
                  <div className="flex items-center space-x-1.5 font-mono">
                    ...
                    <span>Attar Gali, Mumbai (Mon–Sat: 11 AM–9:30 PM)</span>
                  </div>
                </div>

                {/* Calendar Card */}
                <div className="border border-purple-500/30 rounded-xl sm:rounded-2xl p-3 bg-[#1e073c] space-y-3">
                  <div className="flex items-center justify-between text-xs font-extrabold text-white px-1">
                    <button
                      type="button"
                      disabled={isPrevMonthDisabled}
                      onClick={handlePrevMonth}
                      className="px-2.5 py-1 rounded-lg bg-[#0c021c] border border-purple-500/30 hover:bg-purple-900 text-amber-300 flex items-center space-x-1 transition-colors disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
                    >
                      <i className="fa-solid fa-chevron-left text-[10px]"></i>
                      <span>Prev</span>
                    </button>

                    <span className="text-sm font-black text-white tracking-wide bg-[#0c021c] px-3 py-1 rounded-lg border border-purple-500/30 font-serif">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-[#0c021c] border border-purple-500/30 hover:bg-purple-900 text-amber-300 flex items-center space-x-1 transition-colors cursor-pointer"
                    >
                      <span>Next</span>
                      ...
                      return (
                        <button
                          ...
                          className={`p-1.5 sm:p-2 rounded-xl transition-all text-xs font-bold cursor-pointer ${
                            isPast
                              ? "text-slate-600 bg-[#0c021c]/40 opacity-30 pointer-events-none line-through"
                              : isSelected
                              ? "bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-slate-950 font-black shadow-[0_0_15px_rgba(245,158,11,0.4)] scale-105"
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {(() => {
                    ...
                    if (activeSlots.length === 0) {
                      return (
                        <div className="p-3 text-center rounded-xl bg-[#1e073c] border border-purple-500/30 space-y-1.5 my-1">
                          <p className="text-xs text-amber-300 font-bold flex items-center justify-center space-x-1">
                            <span>⏰</span>
                          ...
                          return (
                            <button
                              ...
                              className={`w-full p-2.5 rounded-xl text-xs font-bold transition-all shadow cursor-pointer ${
                                isBooked
                                  ? "bg-[#0c021c] border border-purple-500/20 text-slate-500 line-through opacity-50 cursor-not-allowed flex items-center justify-center space-x-1"
                                  : "bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-slate-950 font-extrabold hover:scale-[1.02] active:scale-95 flex items-center justify-center space-x-1"
                              }`}
                            >
          ...
          {step === 4 && (
            <div className="bg-gradient-to-b from-[#24084c] via-[#1a0538] to-[#100324] text-white border border-emerald-500/40 w-full max-w-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-2xl relative text-center space-y-4 font-sans my-auto">
              ...
              <div>
                <h4 className="text-lg sm:text-xl font-black text-white font-serif">
                  Store Visit / Fitting Slot Booked! 🎉
                </h4>
              ...
              <div className="bg-[#12032b] border border-purple-500/30 rounded-2xl p-3.5 text-left text-xs text-slate-300 space-y-1 font-mono">
                <div><span className="text-purple-300">Name:</span> {contactInfo.fullName || "Customer"}</div>
                <div><span className="text-purple-300">Phone:</span> {contactInfo.countryCode} {contactInfo.phone || "N/A"}</div>
                <div><span className="text-purple-300">Location:</span> Attar Gali, Mumbai</div>
                <div><span className="text-purple-300">Booked Slot:</span> {formattedBookingDate} ({selectedTimeSlot})</div>
                {generatedMeetUrl && (
                  <div className="pt-1.5 border-t border-purple-500/30 text-amber-300">
                    <span className="text-purple-300 block">Meeting / Video Link:</span>
                    <a href={generatedMeetUrl} target="_blank" rel="noopener noreferrer" className="font-bold underline text-amber-400 break-all hover:text-white">
                      🎥 {generatedMeetUrl}
                    </a>
                  </div>
                )}
              ...
              <div className="flex items-center space-x-2 pt-1">
                <button
                  ...
                  className="flex-1 bg-purple-900/60 hover:bg-purple-900 border border-purple-400/40 text-purple-200 font-bold py-2.5 px-3 rounded-xl text-xs transition-colors flex items-center justify-center space-x-1.5 cursor-pointer"
                >
                  <i className="fa-solid fa-calendar-pen text-xs text-amber-400"></i>
